if (location.href==='http://localhost:8888/bin-debug/SaveToDisk.html') return;
...
function bindCenter() {	
	...
	dragresize.ondragmove = function(isResize, ev) { 
		...
		if(w<190){setStyle(asAction,'right',rightoffset+'px');}
		else{setStyle(asAction,'right',0+'px');}
...
function getClientH() {
	return document.compatMode === "CSS1Compat" 
		? html.clientHeight : document.body.clientHeight;
}
